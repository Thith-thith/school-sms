    ...
    <nav className="backdrop-blur-md bg-white/30 dark:bg-gray-900 fixed w-full z-20 top-0 left-0 dark:border-gray-600">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div className="flex items-center lg:order-2">
          ...
          {/* <!-- Dropdown menu --> */}
          <div
            className="hidden overflow-hidden z-50 my-4 max-w-sm text-base list-none bg-white divide-y divide-gray-100 bg-white-400 shadow-lg dark:bg-gray-700 dark:divide-gray-600 rounded-xl"
            id="apps-dropdown"
          >
            <div className="block py-2 px-4 text-base font-medium text-center text-gray-700 bg-gray-50 dark:bg-gray-600 dark:text-gray-300">
              Applications
            ...
            >
              <div className="inline-flex items-center">
                <svg
                  ...
                  viewBox="0 0 24 24"
                  fill="currentColor"
                  className="mr-2 w-7 h-7 text-gray-500 dark:text-gray-400"
                >
                  <path
                    fill-rule="evenodd"
                ...
                <h1 className="mt-1 font-bold">Weteka Studio</h1>
              </div>
            </a>
          </div>
        </div>
